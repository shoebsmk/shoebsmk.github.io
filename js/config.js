...
export const EMAILJS_CONFIG = {
  PUBLIC_KEY: 'TWAsvGbZDMpSbKR6u', // Your EmailJS Public Key (from Account > General)
  SERVICE_ID: 'service_62iqh8d',  // Your EmailJS Service ID (from Email Services > Gmail)
  TEMPLATE_ID: 'template_z4psrkr' // Your EmailJS Template ID (from Email Templates)
}
