...
const ENTRY_IDS = { 
  name: 'entry.537121180', 
  email: 'entry.727807903', 
  phone: 'entry.142400821', 
  reasonMain: 'entry.373929218', 
  reasonOther: 'entry.373929218.other_option_response' 
}
...
if (reasonSelect && reasonOtherRow) {
  reasonSelect.addEventListener('change', function () { 
    reasonOtherRow.classList.toggle('hidden', this.value !== 'Other')
  })
}
